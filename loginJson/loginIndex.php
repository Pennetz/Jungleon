...
<html lang="it">
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
				<h1 class="alert alert-access"> LOGIN </h1>
                <?php
                	if (isset($_GET["errore"])){
                ?>
                <h3 class="alert alert-danger"> <?php echo $_GET["errore"] ?> </h3>
                <?php } ?>
                <form id="form" action="./passwordSave.php" method="POST"> <!--  -->
                    ...
                    <input id="btnRegistra" type="submit" class="btn btn-primary" value="Accedi">
                     oppure 
                    <a href="index.php" type="button" class="btn btn-primary">Registrati</a>
                </form>
            </div>
